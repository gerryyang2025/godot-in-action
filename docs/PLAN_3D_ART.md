...
- 无人机：已具备机身、翼片、旋翼、前向传感器、危险环，以及可区分的三类轮廓。当前玩法已升级为 7 架开局无人机加 5 架分段增援机，其中巡逻型负责维持常规路线并投下圆环警戒线、猎手型会进入短时追击并投下箭头投影、封锁型负责扫荡关键通道并用双轨道投影压缩路线；三类单位还拥有不同的近距离占位音色。玩家现已具备“利用掩体打断视线”与“干扰脉冲”两种脱离追击手段，但尚未把整条巡逻路径投影到地面。
